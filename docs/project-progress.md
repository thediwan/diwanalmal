...
| المعاملات | 🟢 يعمل | قائمة + إضافة/تعديل/حذف؛ دخل/مصروف/تحويل/ذمم؛ **تشاركية (split)** v12؛ **هاتف/واتساب + حماية الذمم الفرعية** v13 |
...
- [x] **هاتف جهات الاتصال + واتساب** (schema v13): `contacts.phone`, `WhatsAppService`, تذكير المشاركين بعد الحفظ
- [x] **حماية ذمم التشاركية**: لا حذف/تعديل مستقل؛ حذف متسلسل مع المعاملة الأصلية
...
- [x] ميزانيات شهرية حسب الفئة (`budgets`)
...
- [x] تقارير شهرية (لقطات مجمدة + رؤى + فائض + PDF)
- [x] ميزانيات شهرية حسب الفئة
- [x] مقارنة بين الشهور
- [ ] تقارير سنوية
- [ ] تصدير CSV
