...
- [ ] نموذج إضافة معاملة (`/transactions/add`) — دخل / مصروف
- [ ] ربط بالفئات (`categories`)
- [ ] تحويل بين المحافظ (`transfers`)
- [ ] تحديث Dashboard تلقائياً بعد الإضافة
- [ ] فلترة وبحث (اختياري)

### المرحلة 3 — الديون والأهداف والميزانيات

- [ ] إدارة الديون (`debts` + `debt_payments`)
- [ ] إضافة/تعديل الأهداف المالية
- [ ] ميزانيات شهرية حسب الفئة (`budgets`)
- [ ] ربط أزرار «إضافة هدف» و«المزيد» في Dashboard
